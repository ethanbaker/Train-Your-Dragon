...
def tutorial():
    ...
    print()
    s(2.5)
    print(co.y + 'Yellow lines are warning lines. They appear when you don\'t answer in the correct format.')
    print()
    s(2.5)
    print(co.m + 'Magenta lines show that the game is saving or loading.')
    print()
    s(2.5)
    print(co.r + 'Red lines show danger.')
    print()
    s(2.5)
    ...
    print()
    s(2.5)
    print('Your dragon has some stats that can be leved up. These are attack, defence, dodge, speed, and stamina. The stats and their affects are listed below.')
    print()
    s(2.5)
    print('The more attack points your dragon has, the more damage your dragon does to other opponents.')
    print()
    s(2.5)
    print('The more defence points your dragon has, the less damage other opponents can do to your dragon.')
    print()
    s(2.5)
